---
title: "Build project on the cloud"
chapter: false
weight: 2
---

Verify that your user is logged in by running the following command.
...
```bash
wget https://tms-cicd-workshop.s3.eu-north-1.amazonaws.com/src/Web-App-Archive.zip
```
...
After moving the files, your local repo should like the one below. ![cloud9](/images/Cloud9-IDE-Screen-Sample.png)
...
![buildsuccess](/images/Lab1-CodeCommit-Success.png)
...
--template-body https://tms-cicd-workshop.s3.eu-north-1.amazonaws.com/src/01-aws-devops-workshop-roles.template \
...
5. Let us **create CodeBuild** project from **CLI**. To create the build project using AWS CLI, we need JSON-formatted input.
    **_Create_** a json file named **_'create-project.json'_** under 'MyDevEnvironment'. ![](/images/create-json.png) Copy the content below to create-project.json. (Replace the placeholders marked with **_<<>>_** with  values for BuildRole ARN, S3 Output Bucket and region from the previous step.) 
...
![buildspec](/images/build-spec.png)
...
![buildsuccess](/images/Lab1-CodeBuild-Success.png)
